...
test::
  ...
  o scp -Bq fubar.example.org:/etc/products.d/baseproduct * (glob)
  ...
  o print ssh -n -o BatchMode=yes fubar.example.org 'zypper -n ar -cgkn sles:12::p=1085 http://dl.example.org/ibs/SUSE:/Maintenance:/1085/SUSE_Updates_SLE-SERVER_12_x86_64/ sles:12::p=1085'
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkn sles:12::p=1085 http://dl.example.org/ibs/SUSE:/Maintenance:/1085/SUSE_Updates_SLE-SERVER_12_x86_64/ sles:12::p=1085
