...
test::
  ...
  o ssh -n -o BatchMode=yes root@omg.example.org 'zypper -n ar -cgkfn sle-module-toolchain:12::up http://*/SLE-Module-Toolchain/12/x86_64/update/ sle-module-toolchain:12::up' (glob)
  ...
  o ssh -n -o BatchMode=yes root@omg.example.org 'zypper -n ar -cgkfn sle-sdk:12::up http://*/SLE-SDK/12/x86_64/update/ sle-sdk:12::up' (glob)
  ...
  o ssh -n -o BatchMode=yes root@wtf.example.org 'zypper -n ar -cgkfn sle-module-toolchain:12::up http://*/SLE-Module-Toolchain/12/x86_64/update/ sle-module-toolchain:12::up' (glob)
  ...
  o ssh -n -o BatchMode=yes root@wtf.example.org 'zypper -n ar -cgkfn sle-sdk:12::up http://*/SLE-SDK/12/x86_64/update/ sle-sdk:12::up' (glob)
