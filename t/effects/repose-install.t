...
test default behavior (adds default repos)::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sle-module-legacy:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-Module-Legacy/12/x86_64/update/ sle-module-legacy:12::up
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sle-module-legacy:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-Module-Legacy/12/x86_64/update/ sle-module-legacy:12::up
...
test that `-t/--tag` provides defaults to tagless patterns::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sle-we:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-WE/12/x86_64/product_debug/ sle-we:12::dg
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update/ sled:12::up
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::at http://www2.ati.com/suse/sle12/ sled:12::at
  ssh -n -o BatchMode=yes fubar.example.org zypper -n --gpg-auto-import-keys in -l sled-release
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sle-we:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-WE/12/x86_64/product_debug/ sle-we:12::dg
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sled:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update/ sled:12::up
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sled:12::at http://www2.ati.com/suse/sle12/ sled:12::at
  ssh -n -o BatchMode=yes snafu.example.org zypper -n --gpg-auto-import-keys in -l sled-release
...
test that tag negation means "all tags but these"::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-DESKTOP/12/x86_64/product_debug/ sled:12::dg
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update_debug/ sled:12::du
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::nv http://download.nvidia.com/novell/sle12/ sled:12::nv
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::at http://www2.ati.com/suse/sle12/ sled:12::at
  ssh -n -o BatchMode=yes fubar.example.org zypper -n --gpg-auto-import-keys in -l sled-release
...
FIXME: installs already present products::
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkn sle-we:12::gm http://dl.example.org/ibs/SUSE/Products/SLE-WE/12/x86_64/product/ sle-we:12::gm
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sle-we:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-WE/12/x86_64/update/ sle-we:12::up
  ssh -n -o BatchMode=yes snafu.example.org zypper -n --gpg-auto-import-keys in -l sle-we-release
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkn sle-we:12::gm http://dl.example.org/ibs/SUSE/Products/SLE-WE/12/x86_64/product/ sle-we:12::gm
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sle-we:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-WE/12/x86_64/update/ sle-we:12::up
  ssh -n -o BatchMode=yes fubar.example.org zypper -n --gpg-auto-import-keys in -l sle-we-release
