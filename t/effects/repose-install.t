...
FIXME: installs already present products::
  ...
  ssh -n -o BatchMode=yes rofl.example.org zypper -n ar -cgkfn sle-we:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-WE/12/x86_64/update/ sle-we:12::up
  ...
  ssh -n -o BatchMode=yes lmao.example.org zypper -n ar -cgkfn sle-we:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-WE/12/x86_64/update/ sle-we:12::up
