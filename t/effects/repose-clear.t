...
test::
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n rr http://www2.ati.com/suse/sle12/
  ssh -n -o BatchMode=yes snafu.example.org zypper -n rr http://dl.example.org/ibs/SUSE/Products/SLE-SDK/12/x86_64/product/
  ssh -n -o BatchMode=yes snafu.example.org zypper -n rr http://dl.example.org/ibs/SUSE/Updates/SLE-SDK/12/x86_64/update/
