...
test adds only requested repos::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update/ sles:12::up
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update_debug/ sles:12::du
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update/ sles:12::up
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update_debug/ sles:12::du
...
test that `-t/--tag` provides defaults to tagless patterns::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkn sles:12::gm http://dl.example.org/ibs/SUSE/Products/SLE-SERVER/12/x86_64/product/ sles:12::gm
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-SERVER/12/x86_64/product_debug/ sles:12::dg
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sled:12::at http://www2.ati.com/suse/sle12/ sled:12::at
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkn sles:12::gm http://dl.example.org/ibs/SUSE/Products/SLE-SERVER/12/x86_64/product/ sles:12::gm
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-SERVER/12/x86_64/product_debug/ sles:12::dg
...
test that tag negation means "all tags but these"::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update_debug/ sles:12::du
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgkfn sles:12::dl http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update_debug/ sles:12::dl
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-SERVER/12/x86_64/product_debug/ sles:12::dg
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update_debug/ sles:12::du
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgkfn sles:12::dl http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update_debug/ sles:12::dl
