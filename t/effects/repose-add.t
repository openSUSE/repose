...
no attempt to skip already-present repos::
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgknf sles:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update/ sles:12::up
  ...
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgknf sled:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update/ sled:12::up
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgknf sled:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-DESKTOP/12/x86_64/product_debug/ sled:12::dg
  ssh -n -o BatchMode=yes fubar.example.org zypper -n ar -cgknf sled:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update_debug/ sled:12::du
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgknf sles:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update/ sles:12::up
  ...
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgknf sled:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update/ sled:12::up
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgknf sled:12::dg http://dl.example.org/ibs/SUSE/Products/SLE-DESKTOP/12/x86_64/product_debug/ sled:12::dg
  ssh -n -o BatchMode=yes snafu.example.org zypper -n ar -cgknf sled:12::du http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update_debug/ sled:12::du
