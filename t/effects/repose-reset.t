...
test::
  ...
  ssh -n -o BatchMode=yes empty.example.org zypper -n ar -cgkfn sles:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12/x86_64/update/ sles:12::up
  ssh -n -o BatchMode=yes empty.example.org zypper -n ar -cgkfn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
  ...
  ssh -n -o BatchMode=yes extras.example.org zypper -n ar -cgkfn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
  ...
  ssh -n -o BatchMode=yes mixup.example.org zypper -n ar -cgkfn sled:12::up http://dl.example.org/ibs/SUSE/Updates/SLE-DESKTOP/12/x86_64/update/ sled:12::up
