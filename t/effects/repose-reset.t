...
test::
  ...
  ssh -n -o BatchMode=yes empty.example.org zypper -n ar -cfgkn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
  ...
  ssh -n -o BatchMode=yes extras.example.org zypper -n ar -cfgkn sles:12::lt http://dl.example.org/ibs/SUSE/Updates/SLE-SERVER/12-LTSS/x86_64/update/ sles:12::lt
